    ...
    return (
      <>
        ...
        >
          <div style={{ width: "100%" }}>
            {[1, 2, 3, 4, 5, 6, 7].map(() => (
              <div
                ...
                style={{ fontSize: "35px", padding: "10px 3px 0px 3px" }}
              >
                <svg
          ...
          <Row style={{ width: "95%", color: "white" }}>
            <Col span={3}>Year</Col>
          ...
          <div style={{ width: "95%", position: "relative", color: "white" }}>
          ...
          <div style={{ paddingTop: "8px", color: "white" }}>06/02/2019</div>
        </div>
      </>
    );
  }
